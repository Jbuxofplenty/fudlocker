...
export default class Home extends Component {
  ...
  _getLocationAsync = async () => {
    ...
    var coords = this.regionFrom(location.coords.latitude, location.coords.longitude, this.props.navigation.state.params.radius*2*1609.34);
  ...
  validateRadius = () => {
    ...
    if( isNaN(temp) ){
        ...
        this.props.navigation.state.params.radius = temp;
        this._getLocationAsync;
    }
  };
          ...
          <View style={{ flex: 1 }}>
            <View style={{ flexDirection: 'row', height: 40, backgroundColor: 'darkgray', borderWidth: 1, borderRadius: 25, borderColor: 'black'}}>
                <View style={{ textAlign: 'left', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', float: 'left', width: '50%' }}>
                    <Text style={{height: 40, textAlign: 'left', textAlignVertical: 'center', fontFamily: 'Poor Story'}}>
                        Current Radius: {'\t'} {this.props.navigation.state.params.radius + " miles"}
                    </Text>
                </View>
            ...
            <MapView
             ...
             {<Circle
                 ...
                 radius={this.props.navigation.state.params.radius*1609.34}
